...
const COLUMNS: { header: string; key: string; width: number }[] = [
  ...
  // firmographics (LinkedIn / Apollo-style profile fields)
  { header: "domain", key: "domain", width: 26 },
  { header: "industry", key: "industry", width: 46 },
  { header: "industry_section", key: "industry_section", width: 40 },
  { header: "company_type", key: "company_type", width: 22 },
  { header: "employee_range", key: "employee_range", width: 16 },
  { header: "revenue_range", key: "revenue_range", width: 18 },
  { header: "linkedin_url", key: "linkedin_url", width: 40 },
  { header: "facebook_url", key: "facebook_url", width: 36 },
  { header: "instagram_url", key: "instagram_url", width: 34 },
  { header: "x_url", key: "x_url", width: 30 },
  // sector / taxonomy
...
async function fetchRows(): Promise<Row[]> {
  const res = await db.execute(sql`
    SELECT
      ...
      o.category_fields->'firmographics'->>'domain'          AS domain,
      o.category_fields->'firmographics'->>'industry'        AS industry,
      o.category_fields->'firmographics'->>'industry_section' AS industry_section,
      ...
      o.category_fields->'firmographics'->>'facebook_url'    AS facebook_url,
      o.category_fields->'firmographics'->>'instagram_url'   AS instagram_url,
      o.category_fields->'firmographics'->>'x_url'           AS x_url,
